...
Use this skill to design and implement bold, production-ready frontends when the request involves UI. Combine it with repository UI/UX requirements (`.agents/rules/animations-and-effects.md`) and existing design systems.
